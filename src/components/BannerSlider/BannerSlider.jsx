            ...
            <span className="slide__feedback">
              <span className="slide__person-container">
                <span className="slide__person">
                  <img
                    className={classNames("person_image", {
                      Esther: element.person_image === EstherFoward,
                    })}
                    alt="person"
                    src={element.person_image}
                  />
                  <span className="slide__person-info">
                    <p className="slide__person-name">{element.person_name}</p>
                    <p className="slide__person-position">
                      {element.person_position}
                    </p>
                  </span>
                </span>
                <span
                  className={classNames("slide__rating", {
                    EstherStar: element.person_image === EstherFoward,
                  })}
                >
