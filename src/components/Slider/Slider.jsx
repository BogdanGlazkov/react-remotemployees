...
export const Slider = () => {
  ...
  const [isAraptmentsButtonClicked, setIsApartmentsButtonClicked] =
    useState(false);

  const handleFilterHouse = () => (
    setFilteredBuildings(
      buildings.filter((element) => element.type === "house")
    ),
    setPosition(0),
  ...
  const handleFilterVillas = () => (
    setFilteredBuildings(
      buildings.filter((element) => element.type === "villa")
    ),
    setPosition(0),
  ...
  const handleFilterApartments = () => (
    setFilteredBuildings(
      buildings.filter((element) => element.type === "apartments")
    ),
    setPosition(0),
        ...
        <span className="slider__head ">
          <span className="slider__head-title__container">
            <span className="slider__head-title--first-part">
              <img
                className="slider__head-title--first-part-image"
                alt="line"
                src={line}
              />
              <p className="slider__head-title--first-part-text">
                Our Recommendation
              </p>
            </span>
          ...
          <span className="slider__filter-buttons">
            ...
            <button
              className={classnames("slider__filter-button", {
                isActive: isAraptmentsButtonClicked,
              })}
      ...
      <div className="slider__cards grid__item--desktop-5-36  grid__item--mobile-2-12 grid__item--tablet-2-12">
        {filteredBuildings.map((building) => {
          return (
            ...
            >
              <img className="slider__image" src={building.image} alt="silde" />
              ...
              <span className="slider__card-info">
                ...
                >
                  <img
                    className="slider__modal-image"
                    src={building.modal_image}
                    alt="fire"
                  />
                  {building.modal_text}
                </p>
                <span className="slider__owner-info">
                  ...
                  <p className="slider__owner-location">
                    {building.owner_location}
                  </p>
                </span>
              </span>
            </div>
